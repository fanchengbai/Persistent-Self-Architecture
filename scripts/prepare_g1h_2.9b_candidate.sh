...
MANIFEST="${PROJECT_ROOT}/configs/assets/exp001_rwkv7_g1h_2.9b_candidate.json"
PYTHON_BIN="${PYTHON_BIN:-python3}"

export PYTHONPATH="${PROJECT_ROOT}/src${PYTHONPATH:+:${PYTHONPATH}}"

echo "PSA asset root: ${ASSET_ROOT}"
echo "Pinned G1h 2.9B candidate plan:"
...
echo "RWKV-7 G1h 2.9B candidate assets are ready."
