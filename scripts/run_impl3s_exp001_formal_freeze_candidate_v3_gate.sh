...
FORMAL_CONFIG="${PROJECT_ROOT}/configs/preregistration/exp001_track_s.formal_v3.json"
...
OUTPUT_DIR="${PSA_IMPL3S_OUTPUT:-${PROJECT_ROOT}/results/development/impl3s_exp001_formal_freeze_candidate_v3}"
...
echo "Impl-3s EXP-001 formal freeze candidate v3 gate finished."
echo "The Impl-3q and Impl-3r failures remain unchanged."
