...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify the no-model D7 held-out causal-transfer preregistration design"
    )
        ...
        json.dumps(
            {
                ...
                "independence_checks": len(report["independence"]["checks"]),
                "future_joint_forward_calls": report["count_derivation"][
