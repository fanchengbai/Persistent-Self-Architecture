...
GATE_CONFIG="${PROJECT_ROOT}/configs/gates/impl2_checkpoint_roundtrip.dev.json"
ASSET_MANIFEST="${PROJECT_ROOT}/configs/assets/exp001_rwkv7_world_0.4b.json"
ASSET_ROOT="${PSA_ASSET_ROOT:-${PROJECT_ROOT}/.psa-assets}"
OUTPUT_DIR="${PSA_IMPL2_OUTPUT:-${PROJECT_ROOT}/results/development/impl2_checkpoint_roundtrip}"
...
echo "Impl-2 checkpoint roundtrip gate finished."
