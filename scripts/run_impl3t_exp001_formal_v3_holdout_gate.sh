...
OUTPUT_DIR="${PSA_IMPL3T_OUTPUT:-${PROJECT_ROOT}/results/development/impl3t_exp001_formal_v3_holdout}"
...
echo "Impl-3t EXP-001 formal v3 one-shot holdout gate finished."
echo "The v3 prompts were not changed."
