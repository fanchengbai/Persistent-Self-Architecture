...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify the no-model D9-A within-wrapper preregistration"
    )
        ...
        json.dumps(
            {
                ...
                "calibration_fixtures": report["expansion_and_independence"][
                    "calibration_fixture_count"
                ],
                "heldout_fixtures": report["expansion_and_independence"][
                    "heldout_fixture_count"
                ],
                "future_forward_calls": report["expansion_and_independence"][
                    "future_forward_call_count"
                ],
