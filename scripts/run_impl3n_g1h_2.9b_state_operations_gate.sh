...
GATE_CONFIG="${PROJECT_ROOT}/configs/gates/impl3n_g1h_2.9b_state_operations.dev.json"
...
OUTPUT_DIR="${PSA_IMPL3N_OUTPUT:-${PROJECT_ROOT}/results/development/impl3n_g1h_2.9b_state_operations}"
...
echo "Impl-3n G1h 2.9B state operations gate finished."
