...
GATE_CONFIG="${PROJECT_ROOT}/configs/gates/impl2b_state_operations.dev.json"
ASSET_MANIFEST="${PROJECT_ROOT}/configs/assets/exp001_rwkv7_world_0.4b.json"
ASSET_ROOT="${PSA_ASSET_ROOT:-${PROJECT_ROOT}/.psa-assets}"
OUTPUT_DIR="${PSA_IMPL2B_OUTPUT:-${PROJECT_ROOT}/results/development/impl2b_state_operations}"
...
echo "Impl-2b state operations gate finished."
