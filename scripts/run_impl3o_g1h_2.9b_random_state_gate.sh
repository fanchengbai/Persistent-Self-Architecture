...
GATE_CONFIG="${PROJECT_ROOT}/configs/gates/impl3o_g1h_2.9b_random_matched.dev.json"
...
OUTPUT_DIR="${PSA_IMPL3O_OUTPUT:-${PROJECT_ROOT}/results/development/impl3o_g1h_2.9b_random_matched}"
...
echo "Impl-3o G1h 2.9B matched random state gate finished."
