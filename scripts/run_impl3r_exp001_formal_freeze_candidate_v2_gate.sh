...
FORMAL_CONFIG="${PROJECT_ROOT}/configs/preregistration/exp001_track_s.formal_v2.json"
...
echo "Impl-3r EXP-001 formal freeze candidate v2 gate finished."
echo "The Impl-3q failure remains unchanged."
