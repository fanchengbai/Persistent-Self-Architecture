...
> 最后更新：2026-08-04
> 当前节点：EXP-001B补充集生成已获负责人独立授权；等待云端生成并冻结11,008条记录
...
| 38g. EXP-001B补充集生成门 | 🟡 已授权生成，等待云端冻结 | 加固版云端预检绑定冻结包、11,008条预算和12个生成相关文件；负责人逐字确认新checksum，只授权生成并冻结补充集 | 防止旧授权复用，并继续把“生成试卷”和“运行实验”分成两个独立权限 | 有效预检digest=`dbb17d97…2ae6`；负责人授权范围为5,120+5,120+768=11,008条生成，明确`run_supplemental_experiment=false`。当前授权已成立，但补充集尚未生成，模型未加载、试题未评分、实验未运行/未观察 | 项目负责人授权；等待云端执行 |
...
12. 生成器、完整性验证和独立授权锁已经就绪，等待云端生成；正式运行仍需未来另一份独立授权。
