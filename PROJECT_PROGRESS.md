...
> 最后更新：2026-08-04
> 当前节点：EXP-001B候选checksum已获负责人确认；最终预注册包工具就绪，等待云端最终化
...
| 38f. EXP-001B最终预注册包 | 🟡 工具完成，等待云端最终化 | 原样复制候选、验证报告和22份证据，加入负责人确认记录，生成包级manifest并独立复核 | 把自然语言确认变成机器可验证、可提交Git的冻结包，同时继续阻断数据生成和实验运行 | 一次性最终化、幂等复核、精确确认文本和越权拒绝均已实现；新增5项专项测试后全项目159项通过。尚未在云端生成最终包 | Codex |
...
7. 最终化与独立复核工具已通过159项全项目测试，下一步在云端生成`preregistration/exp001b/final_v1`；
8. 本次确认不包含EXP-001B测试集生成或正式运行；两者分别需要后续独立授权。
